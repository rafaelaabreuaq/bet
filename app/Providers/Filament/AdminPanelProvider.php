...
use App\Filament\Admin\Pages\EzzeBankPaymentPage;
                        ...
                        NavigationGroup::make('Pagamentos')
                            ->items([
                                ...
                                NavigationItem::make('suitpay-pagamentos')
                                    ...
                                    ->label(fn (): string => 'Digito Pagamentos')
                                    ->url(fn (): string => DigitoPayPaymentPage::getUrl())
                                    ->isActiveWhen(fn () => request()->routeIs('filament.pages.suit-pay-payment-page'))
                                    ->visible(fn(): bool => auth()->user()->hasRole('admin')),

                                NavigationItem::make('ezzebank-pagamentos')
                                    ->icon('heroicon-o-currency-dollar')
                                    ->label(fn (): string => 'Ezzebank Pagamentos')
                                    ->url(fn (): string => EzzeBankPaymentPage::getUrl())
                                    ->isActiveWhen(fn () => request()->routeIs('filament.pages.suit-pay-payment-page'))
                                    ->visible(fn(): bool => auth()->user()->hasRole('admin')),
                            ])
                        : NavigationGroup::make()
