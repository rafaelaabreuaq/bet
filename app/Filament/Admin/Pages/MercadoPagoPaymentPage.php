...
class MercadoPagoPaymentPage extends Page
{
    use MercadoPagoTrait;

    protected static ?string $navigationIcon = 'heroicon-o-currency-dollar';

    protected static string $view = 'filament.pages.mercadopago-payment-page';

    protected static ?string $navigationLabel = 'MercadoPago Pagamentos';

    protected static ?string $modelLabel = 'MercadoPago Pagamentos';

    protected static ?string $title = 'MercadoPago Pagamentos';

    protected static ?string $slug = 'mercadopago-pagamentos';
    ...
    public function submit(): void
    {
        ...
        $resp = self::mercadoPagoPixCashOut([
