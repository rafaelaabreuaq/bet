        ...
        return $form
            ->schema([
                ...
                Section::make('Suitpay')
                    ...
                    Section::make('Ezzebank')
                    ->description('Ajustes de credenciais para a Ezzebank')
                    ->schema([
                        TextInput::make('ezzebank_uri')
                            ->label('Client URI')
                            ->placeholder('Digite a url da api')
                            ->maxLength(191)
                            ->columnSpanFull(),
                        TextInput::make('ezzebank_cliente_id')
                            ->label('Client ID')
                            ->placeholder('Digite o client ID')
                            ->maxLength(191)
                            ->columnSpanFull(),
                        TextInput::make('ezzebank_cliente_secret')
                            ->label('Client Secret')
                            ->placeholder('Digite o client secret')
                            ->maxLength(191)
                            ->columnSpanFull(),
